            ...
            <div class="row">
                <div class="col">
                    ...
                    <div className="card-body">
                        ...
                        Languages & technologies used:  <strong> HTML, CSS, JavaScript, Node.js, Express, Mongoose and MongoDB. </strong>
                        </h4>
                    ...
                    <div className="card-body">
                        ...
                        Languages & technologies used: <strong> HTML, CSS, JavaScript, Mongoose, MongoDB, Node.js, Express and React. </strong>
                        </h4>
                  ...
                  <div class="w-100"></div>
                    ...
                    <div className="card-body">
                        ...
                        Languages & technologies used:  <strong> HTML, CSS, Ruby, Ruby on Rails. </strong></h4>
                        <h4>
                        </h4>
